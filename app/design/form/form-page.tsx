...
export default function FormPage() {
  ...
  const formAppearance = useForm<z.infer<typeof AppearanceFormSchema>>({
  ...
  return (
    <>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4 dark:border-neutral-800'>
                  <FormControl>
                    <Checkbox checked={field.value} onCheckedChange={field.onChange} id='mobile' />
                  </FormControl>
      ...
      >
        ...
        <br />
        <Form {...formAppearance}>
          <form onSubmit={formAppearance.handleSubmit(onSubmit)} className='space-y-8'>
            <FormField
              control={formAppearance.control}
              name='theme'
              render={({ field }) => (
                <FormItem className='space-y-1'>
                  ...
                  >
                    <FormItem>
                      <FormLabel className='[&:has([data-state=checked])>div]:border-sky-600'>
                        <FormControl>
