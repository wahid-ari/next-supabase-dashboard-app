  ...
  if (pathname.split('/')[1] == 'dashboard') {
    return (
      <Link
        ...
        href={href}
        className={twMerge(
          'flex w-full items-center font-medium justify-start gap-2 rounded px-3 py-1.5 text-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500',
...
NavLink.external = ({ children, className, href, icon, ...props }: Other) => {
  return (
    <a
      ...
      className={twMerge(
        'flex w-full items-center justify-start gap-2 px-3 py-1.5 transition-all',
...
NavLink.login = ({ children, className, href, icon, ...props }: Other) => {
  return (
    <Link
      ...
      href={href}
      className={twMerge(
        'flex w-full items-center justify-start px-3 py-1.5 transition-all',
